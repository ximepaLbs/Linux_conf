--------------------------------------------------------
--  "Acidburn, inspired from "Zenburn" awesome theme 
-- 	simply some changes in colors section
--    Credits to  Adrian C. (anrxc) GPLv2  				  --
--------------------------------------------------------
...
theme.fg_focus  = "#62E7C4"--"#F0DFAF"
theme.fg_urgent = "#FF5900"--"#CC9393"
theme.bg_normal = "#19171A"--"#3F3F3F"
...
-- {{{ Widgets
theme.fg_widget        = "#B3F687"--"#AECF96"
theme.fg_center_widget = "62D10E"--"#88A175"
theme.fg_end_widget    = "#39B7FF"--"#FF5656"
theme.fg_off_widget    = "#2A004A"--"#494B4F"
theme.fg_netup_widget  = "#D5EC06"--"#7F9F7F"
...
--theme.tooltip_[theme.font|0.8|theme.fg_widget|theme.bg_widget|2|theme.fg_widget]
-- }}}
...
-- {{{ Misc icons
theme.tape_icon = theme.confdir .. "/icons/perso/tape_small.png"
...
-- {{{ Widget icons
theme.widget_tape	= theme.confdir .. " /icons/perso/tape_small.png"
